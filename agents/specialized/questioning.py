...
def questioning_agent(client_info: str, reason: str, history: str) -> str:
    ...
    try:
        kb_results = agent.tool.retrieve(
            ...
            retrieveFilter={
            "startsWith": {"key": "approach", "value": "QUESTIONS"},
            }
        )
    ...
    print(f"[DEBUG] RAG content for questioning_agent: '{kb_text}'")
    prompt = PromptTemplates.questioning_prompt(client_info, reason, history, kb_text=kb_text)  
